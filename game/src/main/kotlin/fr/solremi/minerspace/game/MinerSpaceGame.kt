...
import fr.solremi.minerspace.game.screen.EmptyPlanetScreen
...
class MinerSpaceGame(
    ...
    override fun create() {
        try {
            logger.info(TAG, "Starting Miner Space foundation.")
            addScreen(EmptyPlanetScreen(services))
            setScreen<EmptyPlanetScreen>()
