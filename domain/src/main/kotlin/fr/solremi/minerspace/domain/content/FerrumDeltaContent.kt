...
data class CatalogTechnology(
    val id: String,
    val requiredTechnologyIds: Set<String>,
    val unlockDayRegular: Int,
)
...
data class CatalogSector(
    val id: String,
    val tier: SectorTier,
    val requiredSectorIds: Set<String>,
    val targetDayRegular: Int,
    val strategicNovelty: String,
)

data class CatalogDeposit(
    val id: String,
...
data class CatalogBuilding(
    val id: String,
    val tier: String,
    val visualTiers: Int,
)

data class CatalogRobot(
    val family: String,
    val levels: Int,
    val specializations: Set<String>,
)

data class CatalogMission(
    val id: String,
    val group: MissionGroup,
    val requiredMissionIds: Set<String>,
    val rewardSpaceDollars: Long,
)

data class CatalogAchievement(
    val id: String,
    val requiredMissionIds: Set<String>,
)
...
data class CatalogCodexEntry(
    val id: String,
    val category: String,
    val analysisLevels: Int,
...
data class NarrativeMilestone(
    val id: String,
    val transmissionIds: Set<String>,
)

data class CatalogTransmission(val id: String)

data class PlayerProfileDefinition(
    val id: String,
    val dailyProgressPoints: Int,
    val advertisingBonusPercent: Int,
...
class FerrumDeltaContentValidator {
    fun validationErrors(content: FerrumDeltaContent): List<String> {
        ...
        val rawIds = content.resources.filter { it.category == ResourceCategory.RAW }.mapTo(linkedSetOf(), CatalogResource::id)
        ...
        check(content.narrativeMilestones.flatMap { it.transmissionIds }.toSet() == transmissionIds, "transmission_not_archived")
        ...
        content.playerProfiles.forEach {
            ...
            check(it.expectedMinDays > 0 && it.expectedMaxDays >= it.expectedMinDays, "profile_day_range:${it.id}")
        }
        return errors
    }
